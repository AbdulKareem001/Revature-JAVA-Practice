...
public class Strems {
    public static void main(String[] args) {
        ...
        employees.add(new Employee(1, "Abdul", 500000));
        employees.add(new Employee(2, "Kareemm", 300000));
        employees.add(new Employee(3, "Anil", 600000));
        employees.add(new Employee(4, "Kaustubh", 400000));
